# Requirements Archive: v3.0 Deployment & Tech Debt Closure
...
- [x] **DEPLOY-01**: DevCollab web and API are accessible at HTTPS custom domains with valid TLS certificates (`devcollab.fernandomillan.me`, `devcollab-api.fernandomillan.me`)
- [x] **DEPLOY-02**: TeamFlow web and API are accessible at HTTPS custom domains with valid TLS certificates (`teamflow.fernandomillan.me`)
...
|-------------|-------|--------|
| DEPLOY-01 | Phase 27 | Complete |
| DEPLOY-02 | Phase 27 | Complete |
...
*Last updated: 2026-02-20 — DEPLOY-01 and DEPLOY-02 marked complete (devcollab.fernandomillan.me and teamflow.fernandomillan.me live)*
